...
export const DEFAULT_API_HOST = `https://gemini-pro.chat/api`;
export const OPENAI_BASE_URL = "https://gemini-pro.chat/api";
...
export const Azure = {
  ExampleEndpoint: "https://gemini-pro.chat/api",
};
