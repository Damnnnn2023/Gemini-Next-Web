...
export const DEFAULT_API_HOST = `https://gemini-pro.chat/api/openai/`;
export const OPENAI_BASE_URL = "https://gemini-pro.chat/api/openai/";
...
export const Azure = {
  ExampleEndpoint: "https://gemini-pro.chat/api/openai/",
};
